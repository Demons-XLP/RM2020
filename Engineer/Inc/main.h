...
#define Air_Cylinder4_Pin GPIO_PIN_3
#define Air_Cylinder4_GPIO_Port GPIOB
#define Air_Cylinder3_Pin GPIO_PIN_4
#define Air_Cylinder3_GPIO_Port GPIOB
#define Air_Cylinder2_Pin GPIO_PIN_5
#define Air_Cylinder2_GPIO_Port GPIOB
#define Air__Cylinder1_Pin GPIO_PIN_6
#define Air__Cylinder1_GPIO_Port GPIOB
